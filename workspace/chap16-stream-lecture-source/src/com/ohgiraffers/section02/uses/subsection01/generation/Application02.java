...
public class Application02 {
    public static void main(String[] args) {
        ...
        /*rangeClosed(시작값, 종료값) : 시작 값부터 1씩 증가하는 숫자를 종료 값까지 스트림으로 생성*/
