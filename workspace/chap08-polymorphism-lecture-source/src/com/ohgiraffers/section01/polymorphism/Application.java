...
//        현재 레퍼런스 변수 타입은 Animal이기 때문에 Rabbit과 Tiger가 가진 고유한 기능을 호출하지 못한다.
//        a1.jump();
//        a2.bite();
        ...
        * */
//        ((Tiger)a1).bite();
        /*레퍼런스 변수가 참조하는 실제 인스턴스가 원하는 타입과 맞는지 비교하는 instacneof연산자*/
        System.out.println("instanceof 연산자 확인 =====");
        System.out.println("a1이 Rabbit 타입 인지 확인 : "+(a1 instanceof Rabbit));
        System.out.println("a1이 Tiger 타입 인지 확인 : "+(a1 instanceof Tiger));
        System.out.println("a2이 Rabbit 타입 인지 확인 : "+(a2 instanceof Rabbit));
        System.out.println("a2이 Tiger 타입 인지 확인 : "+(a2 instanceof Tiger));
        System.out.println("===============================================");
        /*상속 받은 타입도 하께 가지고 있다.*/
        System.out.println("a1이 Animal 타입 인지 확인 : "+(a1 instanceof Animal));
        System.out.println("a2이 Animal 타입 인지 확인 : "+(a2 instanceof Animal));
        /*모든 클래스는 Object의 후손이다.*/
        System.out.println("===============================================");
        System.out.println("a1이 Object 타입 인지 확인 : "+(a1 instanceof Object));
        System.out.println("a2이 Object 타입 인지 확인 : "+(a2 instanceof Object));
        System.out.println("===============================================");
