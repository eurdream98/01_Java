...
public class Application02 {
    ...
    * */
    public static void main(String[] args) {
        ...
        * */
//        iarr = new int[];//할당할 크기는 반드시 지정되어야 한다.
        iarr = new int[5];
        darr = new double[10];

        System.out.println(darr);//주소 값이 나온다.
        /* 선언과 할당은 동시에 할 수 있다. */
        int[] iarr2 = new int[5];
...
* */
        ...
        *  String 클래스의 문자열의 길이는 메소드로 제공하는 length() 로 사용하는 점에 유의한다.
        *  */
        ...
        * */
        iarr = new int[100];
        System.out.println("수정 된 iarr의 hashCode : "+iarr.hashCode());
        System.out.println("수정 된 iarr의 길이 : "+iarr.length);

        /* 한 번 할당 된 배열은 지울 수 없다.
        * 단, 참조되지 않는 배열은 일정시간이 지난 후 heap의 old 영역으로 이동하여 GC(가비지 컬렉터)가 삭제 시킨다.
