...
public class Application04 {
    ...
    public static void main(String[] args) {
        ...
        * 인덱스가 아닌 위에서부터의 순번을 의미하며 가장 상단의 위치는 0이아닌 1부터 시작한다.*/
        System.out.println(integerStack.search(5));
        System.out.println(integerStack.get(2));

        /*스택에서 요소를 꺼내는 메소드는 크게 2가지로 볼 수 잇다.
        * peek() : 가장 마지막(상단)에 있는 요소 반환 -> 원본 변경 x
        * pop() : 가장 마지막(상단)에 있는 요소 반환 후 제거 -> 원본 변경 o*/
        ...
        /*꺼내면서 요소를 제거하기 때문에 스택이 비어있는 경우에는 EmptyStackeException이 발생한다.
        * System.out.println("pop() : "+integerStack.pop());*/
    }
}
