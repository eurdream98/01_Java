...
* EX) String 클래스는 implements Comparable(정렬 기준을 구현) 되어 있기 때문에 */
//        Collections.sort(bookList);

        /*가격 오름차순 정렬
        * AsendingPrice 클래스 생성(Comparator 인터페이스를 구현하여 정렬 기준을 작성한다)
        * */
        ...
        * 한 번만 사용하기 위해서는 조금 더 간편하게 익명 클래스(Anonymous Class)를 사용할 수 있다. */
        ...
        Collections.sort(bookList, new Comparator<BookDTO>() {
            ...
            public int compare(BookDTO o1, BookDTO o2) {
                /*가격 내림차순 정렬 조건
                * o2의 가격이 더 큰 경우에 양수를 반환하여 swap 하라는 flag를 전달한다.*/
//                return o1.getPriece()>=o2.getPriece() ? -1 : 1;
                return o2.getPriece() - o1.getPriece();
            }
        });
        ...
        bookList.sort(new Comparator<BookDTO>() {
            ...
            public int compare(BookDTO o1, BookDTO o2) {
                ...
                * 앞의 값이 더 작은 경우 음수를 반환하고 같으면 0을 반환하며 앞ㅁ의 값이 더 큰 경우 양수를 반환한다.*/
        ...
        bookList.sort(new Comparator<BookDTO>() {
            ...
            public int compare(BookDTO o1, BookDTO o2) {
                /*문자열 대소비교는 String 클래스에 정의 된 compareTo() 메소드를 활용한다.
                 * 앞의 값이 더 작은 경우 음수를 반환하고 같으면 0을 반환하며 앞ㅁ의 값이 더 큰 구여우 양수를 반환한다.*/
                return -o1.getTitle().compareTo(o2.getTitle());
            }
        });
