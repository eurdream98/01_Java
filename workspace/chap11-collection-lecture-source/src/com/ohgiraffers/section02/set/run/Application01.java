...
public class Application01 {
    public static void main(String[] args) {
        ...
        /*중복 값이 저장 되지 않는다.
        * 동일 객체(주소 값 일치)뿐 아니라 동등 객체(필드 값 일치)도 중복 값으로 판단 되어 처리된다.
        * String 클래스에 equals()와 hashCode()가 오버라이딩 되어 있기 때문이다.
        * */
        hset.add(new String("java"));
        System.out.println("hset : "+hset);

        /*contains()메소드는 해당 객체를 포함하고 있는지 확인하는 메소드로 역서도 동등 객체로 판단한다.
        ...
        * 2. inerator() 메소드로 반복자를 만들어서 연속 처리 */
        ...
        /*Collection 인터페이스의 상위 타입인 Iterable 인터페이스에 iterator() 메소드가 정의 되어있다.
