...
public class A_for {
    ...
    public void testForExample3(){
        ...
        System.out.println("난수까지의 합계 : "+sum);
    ...
    public void testForExample4(){
        ...
        * first와 second 중 어느 것이 더 큰 수인지 확인하면 작은 수 ~ 큰 수 까지의 합계를 구하는 로직으로 작성 가능하다.
        * */
        int min = 0;
        int max = 0;
        int sum = 0;
    ...
    public void printSimpleGugudan(){
        ...
        /* 2~9사이의 수를 입력 받아 구구단을 출력하고, 해당 범위의 수를 입력하지 않으면
        ...
        * */
        ...
        if(dan>=2&&dan<=9){
            ...
            System.out.println("반드시 2~9사이의 양수르 입력해야합니다.");
        }
    }
}
