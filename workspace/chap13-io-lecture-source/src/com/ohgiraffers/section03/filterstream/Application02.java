...
public class Application02 {
    public static void main(String[] args) {
        ...
        * 즉, 자주 사용 되는 자원(콘솔)에 대해 미리 스트림을 생성해 두었기 때문에 개발자가 별도로 스트림을 생성하지 않아도 된다.*/
        ...
        /*System.in을 InputStreamReader로 변환하여 byte 기반 스트림을 char 기반 스트림으로 변환한 뒤
        * BufferedReader 보조 스트림과 연결한다.*/
        /*BufferedReader br = new BufferedReader(System.in) 불가능 했었는데 형변환 스트림을 활용하여 가능하게 만듦*/
